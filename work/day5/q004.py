...
balance = bank[748596]["account"]["balance"]
bank[748596]["account"]["balance"] = balance + 6000
bank[748596]["transactions"].append(["deposit", 6000, "2026-06-05"])
print("updated balance:", bank[748596]["account"]["balance"])
print("updated transactions:", bank[748596]["transactions"])